...
- 查到狼人后：果断跳预言家公布查验结果，带领好人投出狼人
- 查到好人也有用：可以在讨论中暗示"我觉得某某不太像狼"来拉拢
- 如果有人悍跳预言家：果断对跳，用多次查验结果证明自己
- 没查到狼人时：不急着跳身份，继续潜水查验`;
        break;
      case RoleName.WITCH:
        roleStrategy = `
【女巫策略】
- 解药：优先救关键角色，首晚可以自救（这是合理操作，不要因此被怀疑就慌）
- 毒药：确认狼人身份后再用，不要凭感觉毒人
- 隐藏身份：前期不要暴露女巫身份，除非被逼到必须自证
- 如果你自救了且被怀疑，可以说"如果我是狼人为什么要自救浪费解药"来自证
